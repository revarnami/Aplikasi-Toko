...
import io.swagger.client.model.SaleDetailProfit;
import java.util.*;
...
public class SaleProfit {
  ...
  private List<SaleDetailProfit> saleDetail = null;
   ...
   **/
  @ApiModelProperty(value = "")
  public List<SaleDetailProfit> getSaleDetail() {
    return saleDetail;
  }
  public void setSaleDetail(List<SaleDetailProfit> saleDetail) {
  ...
  public boolean equals(Object o) {
    ...
    SaleProfit saleProfit = (SaleProfit) o;
    return (this.invoiceNo == null ? saleProfit.invoiceNo == null : this.invoiceNo.equals(saleProfit.invoiceNo)) &&
        (this.customerId == null ? saleProfit.customerId == null : this.customerId.equals(saleProfit.customerId)) &&
        (this.subTotalAmount == null ? saleProfit.subTotalAmount == null : this.subTotalAmount.equals(saleProfit.subTotalAmount)) &&
        (this.discountPercentage == null ? saleProfit.discountPercentage == null : this.discountPercentage.equals(saleProfit.discountPercentage)) &&
        (this.discountNominal == null ? saleProfit.discountNominal == null : this.discountNominal.equals(saleProfit.discountNominal)) &&
        (this.taxPercentage == null ? saleProfit.taxPercentage == null : this.taxPercentage.equals(saleProfit.taxPercentage)) &&
        (this.taxNominal == null ? saleProfit.taxNominal == null : this.taxNominal.equals(saleProfit.taxNominal)) &&
        (this.totalAmount == null ? saleProfit.totalAmount == null : this.totalAmount.equals(saleProfit.totalAmount)) &&
        (this.receiveCash == null ? saleProfit.receiveCash == null : this.receiveCash.equals(saleProfit.receiveCash)) &&
        (this.receiveTransfer == null ? saleProfit.receiveTransfer == null : this.receiveTransfer.equals(saleProfit.receiveTransfer)) &&
        (this.remarks == null ? saleProfit.remarks == null : this.remarks.equals(saleProfit.remarks)) &&
        (this.saleDate == null ? saleProfit.saleDate == null : this.saleDate.equals(saleProfit.saleDate)) &&
        (this.salesName == null ? saleProfit.salesName == null : this.salesName.equals(saleProfit.salesName)) &&
        (this.isReceivable == null ? saleProfit.isReceivable == null : this.isReceivable.equals(saleProfit.isReceivable)) &&
        (this.isDone == null ? saleProfit.isDone == null : this.isDone.equals(saleProfit.isDone)) &&
        (this.id == null ? saleProfit.id == null : this.id.equals(saleProfit.id)) &&
        (this.saleDetail == null ? saleProfit.saleDetail == null : this.saleDetail.equals(saleProfit.saleDetail)) &&
        (this.receivable == null ? saleProfit.receivable == null : this.receivable.equals(saleProfit.receivable)) &&
        (this.customer == null ? saleProfit.customer == null : this.customer.equals(saleProfit.customer));
  }
